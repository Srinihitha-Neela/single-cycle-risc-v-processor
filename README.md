...
A simplified **32-bit Single Cycle RISC-V Processor** implemented in **Verilog** and **SystemVerilog**. This project demonstrates the implementation of core datapath components including ALU, Register File, Program Counter, Instruction Memory, Control Unit, Immediate Generator, and Datapath Integration.
